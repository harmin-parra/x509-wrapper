...
# RSA
key = KEY.load_public_key_pem_file("resources/rsa.pem.pub.key")
key = KEY.load_public_key_der_file("resources/rsa.der.pub.key")
...
# ECDSA
key = KEY.load_public_key_pem_file("resources/ecdsa.pem.pub.key")
key = KEY.load_public_key_der_file("resources/ecdsa.der.pub.key")
