...
#CRL
#crl = CRL.load_der_file("files/crl.der")
#crl = CRL.load_pem_file("files/crl.pem")
...
crl = CRL.load_der_file("files/empty.crl")
...
# Delta CRL
#delta = CRL.load_der_file("files/delta.der")
#delta = CRL.load_pem_file("files/delta.pem")
b64 = ""
#delta = CRL.load_base64(b64)
delta = CRL.load_der_file("files/empty.delta.crl")
